...
impl From<ResourceType> for VanguardResourceType {
    fn from(value: ResourceType) -> Self {
        use VanguardResourceType::*;
        match value {
...
pub struct VanguardResource {
    pub name: String,
    pub aliases: Vec<String>,
    pub kind: VanguardResourceType,
    pub content: String,
...
#[wasm_bindgen]
impl VanguardResource {
    #[wasm_bindgen(constructor)]
    pub fn new(
        name: String,
        aliases: Vec<String>,
        kind: VanguardResourceType,
        content: String,
